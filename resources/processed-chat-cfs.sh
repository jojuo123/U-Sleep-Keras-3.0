...
ut extract_hypno --log_dir logs-chat --overwrite --file_regex './erda2/sleep-data/resources/chat/polysomnography/annotations-events-nsrr/*/*.xml' --out_dir './erda2/sleep-data/resources/processed/chat/' --nsrr
