...
# ut extract_hypno --file_regex './erda2/sleep-data/resources/mros/polysomnography/annotations-events-nsrr/visit*/*.xml' --out_dir './erda2/sleep-data/resources/processed/mros/' --log_dir logs-mros --overwrite --nsrr
