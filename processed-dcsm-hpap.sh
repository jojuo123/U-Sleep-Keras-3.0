...
# ut extract_hypno --file_regex './erda2/sleep-data/resources/dcsm/*/*.ids' --out_dir './erda2/sleep-data/resources/processed/dcsm/' --log_dir logs-dcsm --continue_
...
# ut extract_hypno --file_regex './erda2/sleep-data/resources/homepap/polysomnography/annotations-events-nsrr/lab/*/*.xml' --out_dir './erda2/sleep-data/resources/processed/homepap/' --log_dir logs-homepap --continue_
