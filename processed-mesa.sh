...
ut extract_hypno --file_regex './erda2/sleep-data/resources/mesa/polysomnography/annotations-events-nsrr/*.xml' --out_dir './erda2/sleep-data/resources/processed/mesa/' --log_dir logs-mesa --overwrite --nsrr
