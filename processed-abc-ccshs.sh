...
ut extract_hypno --file_regex './erda2/sleep-data/resources/abc/polysomnography/annotations-events-nsrr/*/*.xml' --out_dir './erda2/sleep-data/resources/processed/abc/' --log_dir logs-abc --overwrite
...
# ut extract_hypno --file_regex './erda2/sleep-data/resources/ccshs/polysomnography/annotations-events-nsrr/*.xml' --out_dir './erda2/sleep-data/resources/processed/ccshs/' --log_dir logs-ccshs --continue_
